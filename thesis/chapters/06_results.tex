...
\begin{itemize}
    \item \textbf{Extended Features Impact:} Massive improvement for ReadText task. Random Forest improved from 0.590 to 0.822 (+23pp), SVM from 0.614 to 0.834 (+22pp), Gradient Boosting from 0.500 to 0.724 (+22pp), and XGBoost from 0.628 to 0.794 (+17pp).
...
The dramatic improvement for tree-based and kernel-based models on ReadText (+17--23pp) suggests that:
\begin{enumerate}
    ...
    \item XGBoost shows a more modest gain (+16.6pp) compared to Random Forest (+23.2pp) and SVM (+22.0pp), suggesting boosting benefits less from the additional dimensions at this sample size.
