...
\begin{enumerate}
    ...
    \item \textbf{Evaluate classical machine learning models} (Logistic Regression, SVM, Random Forest, Gradient Boosting, XGBoost) for PD vs HC classification
...
\begin{itemize}
    ...
    \item \textbf{Classical machine learning models} --- We restrict our study to interpretable, classical algorithms (Logistic Regression, SVM, Random Forest, Gradient Boosting, XGBoost). No deep learning or neural network models are used, given the small dataset size and our emphasis on interpretability.
