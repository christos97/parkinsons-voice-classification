...
% Glossary and abbreviation definitions (loaded after Preamble for correct ordering)
\input{glossary}
...
\IfFileExists{frontmatter/approval.tex}{\input{frontmatter/approval}}{}

% Copyright / Declaration page
\IfFileExists{frontmatter/copyright.tex}{\input{frontmatter/copyright}}{}
...
% Glossaries (forced-add ensures all defined entries are printed regardless of \gls{} usage)
\glsaddall
\printglossary[
    type=abbreviations,
    style=long,
    title={Κατάλογος Συντομογραφιών}
]
\printglossary[
    style=altlist,
    title={Γλωσσάρι Τεχνικών Όρων}
]
